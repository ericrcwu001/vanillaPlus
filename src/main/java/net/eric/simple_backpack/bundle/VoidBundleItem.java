...
public class VoidBundleItem extends Item
{
    ...
    public VoidBundleItem(Settings settings, int maxStorage)
    {
        super(settings);
    ...
    private int getItemOccupancy(ItemStack stack)
    {
        ...
        else if (stack.getItem() instanceof VoidBundleItem)
        {
    ...
    /*
        This is the same logic as the SimpleBundle, but
        the items are NOT dropped and the NBT is removed
     */
